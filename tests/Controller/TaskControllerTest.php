...
class TaskControllerTest extends DataFixtureTestCase
{
    ...
    public function testDeleteTaskAction()
    {
        ...
        static::assertSame("Superbe ! La tâche a bien été supprimée.", trim($crawler->filter('div.alert.alert-success')->text()));
    }
    ...
    public function testDeleteTaskActionWhereSimpleUserIsNotAuthor()
    {
        ...
        // Test if success message is displayed
        static::assertSame("Oops ! Seul l'auteur de la tâche ou un admin peut la supprimer !", trim($crawler->filter('div.alert.alert-danger')->text()));
    }
    ...
    public function testDeleteTaskActionWithSimpleUserWhereAuthorIsAnonymous()
    {
        ...
        // Test if success message is displayed
        static::assertSame("Oops ! Seul un admin peut supprimer une tâche de l'utilisateur anonyme !", trim($crawler->filter('div.alert.alert-danger')->text()));
    }
